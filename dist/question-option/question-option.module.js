...
const question_option_controller_1 = require("./question-option.controller");
...
exports.QuestionOptionModule = QuestionOptionModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([question_option_entity_1.QuestionOption])],
        providers: [question_option_service_1.QuestionOptionService],
        controllers: [question_option_controller_1.QuestionOptionController],
    })
